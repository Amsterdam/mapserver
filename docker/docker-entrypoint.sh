...
KILOGRAM_DB_HOST=${KILOGRAM_DB_HOST:-kilogram-read.service.consul}
...
GASTRANSITIE_DB_HOST=${GASTRANSITIE_DB_HOST:-gastransitie-read.service.consul}
...
BLACKSPOTS_DB_HOST=${BLACKSPOTS_DB_HOST:-reistijdenauto-read.service.consul}
BLACKSPOTS_DB_PORT=${BLACKSPOTS_DB_PORT:-5432}
BLACKSPOTS_DB_NAME=${BLACKSPOTS_DB_NAME:-reistijdenauto}
