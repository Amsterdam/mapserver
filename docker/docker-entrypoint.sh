...
OVERLASTGEBIEDEN_DB_HOST=${OVERLASTGEBIEDEN_DB_PORT_5432_TCP_ADDR:-overlastgebieden-read.service.consul}
OVERLASTGEBIEDEN_DB_PORT=${OVERLASTGEBIEDEN_DB_PORT_5432_TCP_PORT:-5432}
