...
sed -i 's#LEGEND_URL_REPLACE#'"$LEGEND_URL"'#g' /srv/mapserver/topografie.map /srv/mapserver/topografie_wm.map /srv/mapserver/bgt.map /srv/mapserver/kbk10.map /srv/mapserver/kbk50.map /srv/mapserver/kaartteksten.map /srv/mapserver/lufo.map /srv/mapserver/lufo2022.map /srv/mapserver/infrarood.map /srv/mapserver/infrarood2022.map
