...
PREDICTIVEPARKING_DB_HOST=${PARKEERVAKKEN_DB_PORT_5432_TCP_ADDR:-predictivepakring-read.service.consul}
PREDICTIVEPARKING_DB_PORT=${PARKEERVAKKEN_DB_PORT_5432_TCP_PORT:-5432}
PREDICTIVEPARKING_DB_USER=${PARKEERVAKKEN_DB_USER:-${PARKEERVAKKEN_DB_NAME}}
