...
RUN : "${MAP_URL:?MAP_URL not set}" \
 ...
 && find /srv/mapserver /srv/mapserver/referentiekaarten /private -maxdepth 1 -type f -name "*.map" -exec sed -i -e "s#MAP_URL_REPLACE#${MAP_URL}#g" -e "s#LEGEND_URL_REPLACE#${LEGEND_URL}#g" {} +
