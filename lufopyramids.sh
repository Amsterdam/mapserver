...
# # find . -type f -size 1651c -delete
# # find . -type d -empty -delete
# # for i in {24..25}
# # do
# #   for j in {15..24}
# #   do
# #       cp -v Ortho_1090_4917_${j}_${i}.tif ..
# #   done
# # done

# # for f in Ortho*; do mv $f ${f/Ortho/0_Ortho}; done

# # 
# for filename in *.ecw
# do
#     docker run --rm -it --name gdalecw -v /mnt/lufo/lufo2005:/home/datafolder ginetto/gdal:2.4.4_ECW gdal_translate /home/datafolder/$(basename "$filename") /home/datafolder/$(basename "$filename" .ecw).tif
# done
DESTDIR_ROOT=$2
DESTDIR=$2/pyramid
YEAR=$3
